...
export default function Index() {
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <Section bgColor="#9B5DE5" audio="AYEK 2.wav">
        <img
          // initial={{ y: 200 }}
          // whileInView={{ y: 10 }}
          // transition={{ duration: 1.5 }}
      ...
      <Section bgColor="#F15BB5" audio="AYEK 3.wav">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
      ...
      <Section bgColor="#03BBF9" audio="AYEK 2.wav">
        <motion.div
          initial={{ y: 0 }}
          whileInView={{ y: 100 }}
          transition={{ duration: 1.5, stiffness: 10 }}
      ...
      <Section bgColor="#02F5D4" audio="AYEK 3.wav">
        <motion.div
          initial={{ y: 100 }}
          whileInView={{ y: 0 }}
          transition={{ duration: 1.5, stiffness: 10 }}
